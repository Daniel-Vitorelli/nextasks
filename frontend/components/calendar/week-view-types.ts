...
export interface WeekViewProps {
  ...
  /** Callback when a empty time slot is double-clicked (create block) */
  onCellDoubleClick?: (day: Date, hour: number) => void;
  ...
  /** Generic (template) mode: hides day numbers and today accent, and the
   * time indicator. Used for recurring routine schedules. */
  generic?: boolean;
  /** date-fns locale used for day names and hour labels */
  locale?: Locale;
...
export interface WeekViewDayColumnsProps {
  ...
  standalone?: boolean;
  /** When true, hides the day numbers and the "today" accent (generic template) */
  hideDayNumber?: boolean;
  /** When true, hides the weekday name label (used in generic day view) */
  hideDayName?: boolean;
...
export interface WeekViewGridProps {
  ...
  /** Callback when an event should be duplicated */
  onEventDuplicate?: (event: CalendarEvent) => void;
  /** Callback when an empty time slot is double-clicked (create block) */
  onCellDoubleClick?: (day: Date, hour: number) => void;
